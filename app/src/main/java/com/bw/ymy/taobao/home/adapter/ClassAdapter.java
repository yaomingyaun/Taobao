...
public class ClassAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<ClassifyBean.ResultBean> mdata;
    ...
    ////刷新更多
public  void  setlist(List<ClassifyBean.ResultBean> datas)
{
        mdata.clear();
        mdata.addAll(datas);
...
//加载更多
    public  void  addlist(List<ClassifyBean.ResultBean> datas)
    {
        mdata.addAll(datas);
        notifyDataSetChanged();
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(mcontext).inflate(R.layout.classfiy_item,null);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
        ClassifyBean.ResultBean bean=mdata.get(i);
    ...
    class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            icon=itemView.findViewById(R.id.class_icon);
